...
const STATUS_META = (t) => ({
  saved:     { cls: 'bg-[#f0f5ff] text-[#0071c2] border-[#dceaff]',  icon: BookOpen,    label: 'Plan saved' },
      ...
      <section className="relative bg-[#003580] text-white overflow-hidden pt-[100px] pb-12">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-8">
          ...
          <p className="text-[14px] md:text-[15px] text-white/80 font-medium">
            {bookings.length} saved · all your AI-built itineraries in one place
          </p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-8">
        ...
        {bookings.length > 0 && (
          <div className="mb-6 flex flex-col md:flex-row gap-3 md:items-center">
            <div className="relative flex-1">
              ...
              <input
                type="text"
                placeholder="Search by destination or confirmation code…"
                value={search}
            ...
            <div className="flex items-center gap-2 overflow-x-auto pb-1">
              ...
              {[
                ...
                { v: 'saved',     l: 'Saved',     n: counts.saved     },
                { v: 'confirmed', l: 'Confirmed', n: counts.confirmed },
                { v: 'pending',   l: 'Pending',   n: counts.pending   },
                { v: 'cancelled', l: 'Cancelled', n: counts.cancelled },
        ...
        {bookings.length === 0 && (
          <div className="bg-white border border-[#e7e7e7] rounded-3xl p-10 md:p-14 text-center shadow-sm relative overflow-hidden">
            <div className="absolute -top-20 -right-20 w-72 h-72 rounded-full bg-[#0071c2]/15 blur-3xl pointer-events-none" />
            <div className="relative">
              <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#003580] to-[#0071c2] flex items-center justify-center mx-auto mb-5 -rotate-3 shadow-xl">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <button onClick={() => navigate('/hot-tours')}
                  ...
                  <Sparkles className="w-4 h-4" /> Start AI Trip Studio
                </button>
                <button onClick={() => navigate('/flights')}
                  className="px-5 py-3 rounded-xl border-2 border-[#e7e7e7] hover:border-[#0071c2] hover:bg-[#f0f5ff] text-[#1a1a1a] text-[13px] font-black flex items-center justify-center gap-2 transition active:scale-95">
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute bottom-3 left-3 right-3 text-white">
                      <div className="flex items-center gap-1 text-[11px] font-bold text-white/85 mb-0.5">
                        <MapPin className="w-3 h-3 text-[#febb02]" /> {dest || 'Destination'}
                      </div>
                  ...
                  <div className="p-4 flex flex-col flex-1">
                    <div className="flex items-center justify-between text-[11px] text-[#595959] font-bold mb-3 flex-wrap gap-x-3 gap-y-1">
                      ...
                      <span className="flex items-center gap-1">
                        <Users className="w-3.5 h-3.5 text-[#0071c2]" />{b.passengers} pax
                      </span>
                    </div>
                    ...
                    <div className="mt-auto flex items-end justify-between pt-3 border-t border-[#f0f0f0]">
                      <div>
                        <div className="text-[10px] text-[#9ca3af] font-bold uppercase">Total</div>
        ...
        {bookings.length > 0 && filtered.length === 0 && (
          <div className="bg-white border border-[#e7e7e7] rounded-2xl p-10 text-center">
            <Search className="w-10 h-10 mx-auto mb-3 text-[#c9d1d9]" />
            <p className="text-[#1a1a1a] font-bold mb-1">No bookings match</p>
            <p className="text-[#9ca3af] text-sm mb-4">Try a different filter or clear your search.</p>
